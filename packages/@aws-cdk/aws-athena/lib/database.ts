...
export class Database extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DatabaseProps) {
    ...
    const onEvent = new lambda.Function(this, 'DatabaseQueryLambda', {
    ...
    const provider = new cr.Provider(this, 'DatabaseQueryProvider', {
...
export class Table extends Construct {
  ...
  constructor(scope: Construct, id: string, props: TableProps) {
    ...
    const onEvent = new lambda.Function(this, 'TableQueryLambda', {
      code: new lambda.InlineCode(handlerCode),
      runtime: lambda.Runtime.PYTHON_3_7,
      handler: 'index.on_event',
      initialPolicy: [
    ...
    const provider = new cr.Provider(this, 'TableQueryProvider', {
      onEventHandler: onEvent
    });
